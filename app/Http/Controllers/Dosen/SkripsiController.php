...
class SkripsiController extends Controller
{
    public function index()
    {
        ...
        $skripsiList = Skripsi::where('pembimbing1_id', $dosen->id)
            ...
            ->orderByRaw("CASE status WHEN 'bimbingan' THEN 1 WHEN 'pengajuan' THEN 2 WHEN 'review' THEN 3 WHEN 'seminar_proposal' THEN 4 WHEN 'penelitian' THEN 5 WHEN 'seminar_hasil' THEN 6 WHEN 'sidang' THEN 7 WHEN 'revisi' THEN 8 WHEN 'selesai' THEN 9 WHEN 'ditolak' THEN 10 WHEN 'diterima' THEN 11 ELSE 12 END")
            ->get();
